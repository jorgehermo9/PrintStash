...
AI Search uses the existing Python import and media pipeline. Its durable source
projection requests are processed by the search worker and have a separate
Alembic migration; the Rust import engine and native build stage are not required.
