...
from app.modules.ingestion import inbox, staging_cleanup, staging_leases
from app.modules.library import source_covers, trash
...
class TestPruneExpired:
    ...
    `staging_cleanup.prune_expired` is a generic reaper, and a cover's lease is
    ...
    def test_prunes_a_cover_intent_whose_bytes_were_never_published(
        ...
        assert staging_cleanup.prune_expired(
