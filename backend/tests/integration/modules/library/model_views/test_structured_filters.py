...
class TestListItems:
    ...
    def test_the_uploaded_filters_bound_the_window_at_both_ends(
        ...
        after = models_listing.list_items(
            db_session,
            user,
            filters=ModelFilters(
        ...
        before = models_listing.list_items(
            db_session,
            user,
            filters=ModelFilters(
    ...
    def test_list_items_picks_newest_version_mesh_file_for_preview(
        ...
        rows = models_listing.list_items(db_session, user, limit=100)
