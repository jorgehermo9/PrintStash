...
class TestParse:
    ...
    def test_parse_prusaslicer_fixture(self) -> None:
        fixture = FIXTURES_DIR / "prusaslicer_sample.gcode"
        result = parse(fixture)
    ...
    def test_parse_bambu_studio_fixture(self) -> None:
        fixture = FIXTURES_DIR / "bambu_studio_sample.gcode"
        result = parse(fixture)
    ...
    def test_parse_cura_fixture(self) -> None:
        fixture = FIXTURES_DIR / "cura_sample.gcode"
        result = parse(fixture)
    ...
    def test_parse_klipper_orca_fixture(self) -> None:
        fixture = FIXTURES_DIR / "klipper_orca_sample.gcode"
        result = parse(fixture)
        assert result["slicer_name"] == "OrcaSlicer"
    ...
    def test_parse_real_prusa_spatula_fixture(self) -> None:
        ...
        fixture = FIXTURES_DIR / "real_prusa_mk4_spatula.gcode"
        result = parse(fixture)
        assert result["slicer_name"] == "PrusaSlicer"
    ...
    def test_preserves_multi_tool_materials_and_colors(self, tmp_path: Path) -> None:
        p = tmp_path / "multi.gcode"
        p.write_text(
        ...
        assert result["material_type"] == "PLA"
        assert result["material_requirements"] == [
            {"tool_index": 0, "material_type": "PLA", "color_hex": "#FF0000"},
            {"tool_index": 1, "material_type": "PETG", "color_hex": "#00FF00"},
        ]
