...
export const SHARED_PRINTER_CONTRACT = {
  ...
  providers: {
    ...
    bambu_lan: {
      capabilities: ["start", "pause", "resume", "cancel", "live_status", "upload"],
      supportLevel: "beta",
      supportNotes: [
    ...
    elegoo_centauri: {
      capabilities: ["start", "pause", "resume", "cancel", "live_status", "upload", "server_info"],
      supportLevel: "beta",
      supportNotes: [
      ...
      configFields: [
        ...
        },
        {
          ...
          kind: "choice",
          required: true,
          choices: ["elegoo_centauri_carbon", "elegoo_centauri_carbon_2"],
        },
        {
          name: "access_code",
          kind: "secret",
