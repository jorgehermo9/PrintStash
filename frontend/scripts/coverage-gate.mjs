...
const SUITES = [
  {
    ...
    total: { statements: 61.7, branches: 58.5 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 88.0, branches: 77.4 },
      ...
      { prefix: "src/components/", statements: 53.7, branches: 54.3 },
      ...
      { prefix: "src/pages/", statements: 71.8, branches: 65.8 },
