...
const SUITES = [
  {
    ...
    total: { statements: 82.4, branches: 77.4 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 93.7, branches: 85.6 },
      ...
      { prefix: "src/components/", statements: 78.8, branches: 75.5 },
      ...
      { prefix: "src/pages/", statements: 88.0, branches: 81.9 },
