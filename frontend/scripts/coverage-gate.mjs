...
const SUITES = [
  {
    ...
    total: { statements: 68.5, branches: 63.5 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 88.3, branches: 78.3 },
      ...
      { prefix: "src/components/", statements: 62.4, branches: 60.3 },
      ...
      { prefix: "src/pages/", statements: 78.2, branches: 69.3 },
