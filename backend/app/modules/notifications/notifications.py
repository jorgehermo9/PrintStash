...
* :func:`enqueue_for_event` is called **inside** the printer hub's existing DB
  transactions (see :mod:`app.modules.printing.printer_hub`). For each enabled channel
...
from app.modules.administration.runtime_config import notifications_enabled
