...
PENDING_INLINE_CONSTRUCTION = {
    "tests/contract/api/v1/test_fleet.py",
    "tests/contract/api/v1/test_printers.py",
    "tests/contract/services/test_elegoo_centauri.py",
    "tests/contract/services/test_octoprint.py",
    "tests/contract/services/test_printer_hub.py",
    "tests/contract/services/test_prusalink.py",
    "tests/e2e/test_auth.py",
    "tests/e2e/test_bambu_external_capture.py",
    "tests/e2e/test_fleet.py",
    "tests/e2e/test_library_transfer.py",
    "tests/e2e/test_notifications.py",
    "tests/e2e/test_oidc.py",
    "tests/e2e/test_printer_rbac.py",
    "tests/e2e/test_sharing.py",
    "tests/e2e/test_trash_legacy_ownership.py",
    "tests/integration/api/v1/files/test_embedded_gcode.py",
    "tests/integration/api/v1/inbox/test_batch.py",
    ...
    "tests/integration/api/v1/models/test_batch_actions.py",
    ...
    "tests/integration/api/v1/printers/test_crud.py",
    "tests/integration/api/v1/printers/test_files.py",
    "tests/integration/api/v1/printers/test_materials.py",
    "tests/integration/api/v1/printers/test_providers.py",
    "tests/integration/api/v1/printers/test_rbac.py",
    "tests/integration/api/v1/printers/test_send.py",
    ...
    "tests/integration/db/migrations/test_provider_connections_migration.py",
    ...
    "tests/integration/services/importer/test_new_features.py",
    "tests/integration/services/inbox/test_capture_slots.py",
    "tests/integration/services/inbox/test_inbox.py",
    ...
    "tests/integration/services/model_views/test_filament_cost.py",
    ...
    "tests/integration/services/model_views/test_vault_stats_cache.py",
    ...
    "tests/integration/services/test_notifications.py",
    "tests/integration/services/test_oidc.py",
    "tests/integration/services/test_print_results.py",
    "tests/integration/services/test_printer_files.py",
    ...
    "tests/integration/services/test_storage_backend.py",
